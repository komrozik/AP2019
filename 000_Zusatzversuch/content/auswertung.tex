...
\end{figure}
Mit der hergeleiteten Formel für die Masse in Abhängigkeit von dem Federdurchmesser und der Windungszahl lassen sich die beiden Abhängigkeiten plotten und eine Ausgleichsrechnung durchführen.
Bei der Ausgleichsrechnung fälllt auf das sie sich im gegebenen Intervall annähernd linear verhält und somit kann der einfluss der beiden größen anhand der linearen Ausgleichsrechnung abgeschätzt werden.
\begin{figure}[H]
  \center
