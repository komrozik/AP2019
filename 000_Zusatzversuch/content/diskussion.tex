...
\begin{align*}
    0&\overset{\text{!}}{=}\frac{G}{8} \cdot \frac{d^4}{(D_a-d)^3\cdot \frac{L0-LH}{d}}-R,
\end{align*}
die angenommene Drahtdicke $d_{ang}=0.434519\;$mm.\\
Mit einer Abweichung von $\Delta d=d-d_{ang}=0.004519\;$mm liegt dieser Wert im Schwankungsbereich
...
\begin{table}[H]
    ...
    \begin{tabular}{c | c c c c}
        \toprule
        & $F1\;/\;N$ & $F2\;/\;N$ & $D_a\;/\;mm$ &$L0\;/\;mm$\\
        \midrule
        Basisfeder (Ist  )&4.83   &8.0   &3.68  &57.06\\
        Idealfeder (Soll) &5.00   &7.9   &3.70  &59.577 (58.0*)\\
        \midrule
        Abweichung        &0.17   &0.1   &0.02  &2.517 (0.94)\\
