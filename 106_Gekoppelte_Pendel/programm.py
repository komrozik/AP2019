...
M1_p = unp.uarray(M1_p,S1_p)
M2_p = unp.uarray(M2_p,S2_p)
...
M1_m = unp.uarray(M1_m,S1_m)
M2_m = unp.uarray(M2_m,S2_m)
...
M1_schwi = unp.uarray(M1_schwi,S1_schwi)
M1_schwe = unp.uarray(M1_schwe,S1_schwe)
...
M2_schwi = unp.uarray(M2_schwi,S2_schwi)
M2_schwe = unp.uarray(M2_schwe,S2_schwe)
